...
# =====================
# Transforms (CNN-friendly)
# =====================
def build_transforms():
    train_transform = transforms.Compose([
        transforms.RandomResizedCrop(224, scale=(0.08, 1.0)),
        transforms.RandomHorizontalFlip(),
        # lighter than ViT recipe (important for CNN stability)
...
def main(args):
    ...
    # =====================
    # Mixup / CutMix (CNN-safe strength)
    # =====================
    mixup_fn = Mixup(
        mixup_alpha=0.2,
        cutmix_alpha=0.2,
    ...
    # Logging
    # =====================
    log_dir = os.path.join(CHECKPOINTS_DIR, args.model_name, str(args.seed))
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_name", default="resnet34_tinyimagenet", type=str)
